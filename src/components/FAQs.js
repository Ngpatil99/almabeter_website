...
const admission = [
    ...
    {
        id: "ad3",
        question: "Is there any selection test for enroling in Speedup courses?",
        answer: "No, you don't have to take any test to enrol in the Full Stack courses that we offer."
    },
    {
        id: "ad4",
        question: "Is it mandatory to opt for the Speedup Career Track?",
        answer: "No, it is not mandatory to opt for Speedup Career Track. However, we strongly recommend opting for AlmaX Career Track in order to get placed amongst our 700+ hiring partners."
    },
]
    ...
    return (
        <>
            <div className="container py-3" id="FAQs">
                <h2 className="pb-0 text-center ">Frequently Ask Questions</h2>
                <p className="text-center  font-weight-bold">lorem lorem lorem lorem lorem lorem lorem lorem lorem</p>
