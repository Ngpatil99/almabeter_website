        ...
        <>
            <div className="container-fluid bg-black py-5">
                <div className="container">
                    <h3 className="text-light">100% Job Assurance with Speed<span className="text-danger">up</span> Career Track</h3>
                ...
                <div className="container py-3">
                    <div className="d-flex align-items-center text-light">
                        ...
                        <h3 className=" m-0 ms-2">Speed<span className="text-danger">up</span> Eligibility Requirements</h3>
                    </div>
                ...
                <div className="container py-3">
                    <div className="d-flex align-items-center text-light">
                        ...
                        <h3 className=" m-0 ms-2">Speed<span className="text-danger">up</span> Curriculum</h3>
                    </div>
                    <img src="./static/red lines.svg" className="mx-5 mb-3" alt="not found" />
                ...
                <div className="container py-4">
                    <div className="d-flex align-items-center text-light">
                        ...
                        <h3 className=" m-0 ms-2">Speed<span className="text-danger">up</span> Career Services</h3>
                    </div>
                    <img src="./static/red lines.svg" className="mx-5 mb-3" alt="not found" />
                    <div className="container d-flex flex-wrap justify-content-around">
