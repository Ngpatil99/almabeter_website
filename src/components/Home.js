...
<section id="hero" className="hero">
      ...
      <img src="./img/video-img.jpg" alt="" data-aos="fade-in"/>

      <div className="container">
        <div className="row">
          <div className="col-lg-10">
            <h2 data-aos="fade-up" data-aos-delay="100">Welcome to Speed<span className="text-danger">up</span> Infotech</h2>
            ...
            <div className="container-fluid my-5" id="Home">
                <div className="container d-flex flex-wrap">
                    <div className="container w-50 homc">
                        ...
                        <p className="collab"><b>Our Proccess Methadology</b></p>
                        ...
                        <ul className="list-group">
                            <li className="list-group-item border-0">
                                ...
                                <span style={{ fontSize: '14px', color: "rgb(108 108 108)" }}>Demo Session</span>
                            </li>
                            <li className="list-group-item border-0">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" className="text-[#20A898] right-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 0 1-51.7 0L318.5 484.9c-3.8-5.3 0-12.7 6.5-12.7h46.9c10.2 0 19.9 4.9 25.9 13.3l71.2 98.8 157.2-218c6-8.3 15.6-13.3 25.9-13.3H699c6.5 0 10.3 7.4 6.5 12.7z"></path></svg>
                                <span style={{ fontSize: '14px', color: "rgb(108 108 108)" }}>Enroll</span>
                            </li>
                            <li className="list-group-item border-0">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" className="text-[#20A898] right-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 0 1-51.7 0L318.5 484.9c-3.8-5.3 0-12.7 6.5-12.7h46.9c10.2 0 19.9 4.9 25.9 13.3l71.2 98.8 157.2-218c6-8.3 15.6-13.3 25.9-13.3H699c6.5 0 10.3 7.4 6.5 12.7z"></path></svg>
                                <span style={{ fontSize: '14px', color: "rgb(108 108 108)" }}>Study Material and syllabus</span>
                            </li>
                            <li className="list-group-item border-0">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" className="text-[#20A898] right-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 0 1-51.7 0L318.5 484.9c-3.8-5.3 0-12.7 6.5-12.7h46.9c10.2 0 19.9 4.9 25.9 13.3l71.2 98.8 157.2-218c6-8.3 15.6-13.3 25.9-13.3H699c6.5 0 10.3 7.4 6.5 12.7z"></path></svg>
                                <span style={{ fontSize: '14px', color: "rgb(108 108 108)" }}>Classroom Online Training</span>
                            </li>
                            <li className="list-group-item border-0">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" className="text-[#20A898] right-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 0 1-51.7 0L318.5 484.9c-3.8-5.3 0-12.7 6.5-12.7h46.9c10.2 0 19.9 4.9 25.9 13.3l71.2 98.8 157.2-218c6-8.3 15.6-13.3 25.9-13.3H699c6.5 0 10.3 7.4 6.5 12.7z"></path></svg>
                                <span style={{ fontSize: '14px', color: "rgb(108 108 108)" }}>Live Project working</span>
                            </li>
                            <li className="list-group-item border-0">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" className="text-[#20A898] right-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 0 1-51.7 0L318.5 484.9c-3.8-5.3 0-12.7 6.5-12.7h46.9c10.2 0 19.9 4.9 25.9 13.3l71.2 98.8 157.2-218c6-8.3 15.6-13.3 25.9-13.3H699c6.5 0 10.3 7.4 6.5 12.7z"></path></svg>
                                <span style={{ fontSize: '14px', color: "rgb(108 108 108)" }}>Mock Interview</span>
                            </li>
                        </ul>
                ...
                <div className="row" data-aos="fade-up">
                    ...
                    <div className=" d-flex flex-wrap justify-content-center py-3 " data-aos="fade-up">
                        ...
                        <img src="./static/c2.svg" alt="compani-logo1" className="img-company-logo col-lg-2 col-md-2 col-sm-2 m-2" />
